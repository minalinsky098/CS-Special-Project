...
public class Main_Project {
    ...
    String QuestionsAnswers[][] = {
            ...
            /* 0 */ {
                    ...
                    "Newton’s first law of motion", " Netwon’s Second law of motion",
    ...
    JLabel QuestionLabel = new JLabel(
            "Question Number " + (QuestionNumber + 1) + ". " + QuestionsAnswers[QuestionNumber][0]);
    ...
    public class Actions implements ActionListener {
        public void actionPerformed(ActionEvent event) {
            ...
            if (event.getSource() == QFNextButton) {
                ...
                /*
                 * // Initialize the array of input fields
                 * inputFields = new JTextField[QUESTIONS.length];
                 * 
                 * // Add the questions and input fields to the frame
                ...
                // {{},{"1","2","2","3","3","3","1","2","1","4","4","3","2","3","1","4","4","3",
                // "1","1","3","4","4","1","2","1","2","1","4","2","2","4","3","1","1","3","1","4","3","1"}};
                ...
                if (QuestionNumber == 0 && option1.isSelected()
                        ...
                        || QuestionNumber == 11 && option3.isSelected()
